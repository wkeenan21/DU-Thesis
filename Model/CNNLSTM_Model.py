...
class HybridModel:
    ...
    def CreateLocalModelTimeSeries(self, featuredim=1, useVar=True):
        ...
        if self.leveloption == 1:
            aq_combine = Concatenate()([aq_l1, aq_l2,  nodeprops_self])
        else:

            aq_combine = Concatenate()([aq_l2, nodeprops_self])
    ...
    def CreateLocalModelAggrDynamic(self, neighbor_list, neighbor_dis_list, neighborhoodsize, timedimension=1,
        ...
        if self.useConv == 3:
            filter_cnt = 4
            neigbhor_edge_weight_reshape = Reshape((timedimension, neighborhoodsize, 1, 1))(
